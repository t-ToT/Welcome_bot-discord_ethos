...
client.on('guildMemberAdd', member => {
	...
	member.guild.channels.get('369435011340042242').send(`Bienvenu à ${member.user.username}, merci de bien vouloir lire les règles, elles vous ont été envoyer par mail également`)
});
